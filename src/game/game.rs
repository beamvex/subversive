...
mod tests {
    ...
    fn test_play() {
        ...
        crate::debug!("private_key1: {}", bytes_to_base36(&private_key1));
        crate::debug!("private_key2: {}", bytes_to_base36(&private_key2));

        let data = b"test";
        let signature1 = sign(data, &private_key1);
        let data = b"test";
        let signature2 = sign(data, &private_key2);
        crate::debug!("signature1: {}", bytes_to_base36(&signature1));
        crate::debug!("signature2: {}", bytes_to_base36(&signature2));
