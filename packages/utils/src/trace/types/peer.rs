...
impl TraceId for PeerInit {
    fn id(&self) -> u64 { 0x0200 }
    fn name(&self) -> &'static str { "PeerInit" }
    fn message(&self) -> String {
        format!("{} {} from {}", green("Initializing peer"), &self.peer, &self.source)
    }
}
...
impl TraceId for PeerKnownCount {
    fn id(&self) -> u64 { 0x0208 }
    fn name(&self) -> &'static str { "PeerKnownCount" }
    fn message(&self) -> String {
        format!("{} {} {}", green("Peer"), &self.addr, format!("has {} known peers", self.count))
    }
}

impl TraceId for PeerRemoved {
    fn id(&self) -> u64 { 0x0209 }
